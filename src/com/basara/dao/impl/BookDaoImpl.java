...
public class BookDaoImpl extends BaseDao implements BookDao {
    ...
    @Override
    public List<Book> queryForPagesItems(int begin, int pageSize) {
    ...
    @Override
    public List<Book> queryForPagesItemsByPrice(int begin, int pageSize, int min, int max) {
